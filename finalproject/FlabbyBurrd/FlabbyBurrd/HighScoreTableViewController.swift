...
//  FlabbyBurrd
//
//  Created by Taylor, Dylan D on 4/26/21.
//
...
class HighScoreTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        self.highScoreTableModel?.LoadData()
        self.highScores = self.highScoreTableModel?.getCoreArray() ?? []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let storedscore = self.highScores[indexPath.row]
        let total : Int16 = (storedscore.value(forKeyPath: "total") as? Int16)!
